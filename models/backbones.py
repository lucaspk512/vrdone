...
class MaskConvTransformerBackbone(nn.Module):
    ...
    def __init__(
        ...
        visual_bbox_ks,        # conv kernel size to fuse visual features and bbox features
        so_fuse_kernel_size,
        n_fuse_head, 
        fuse_path_drop,
        fuse_qx_stride,
        ...
        self.visual_bbox_fuse = ConvMLP(n_embd * 2, n_embd, n_embd, kernel_size=visual_bbox_ks, num_layers=2)
        ...
        self.so_fuse = ConvMLP(n_embd * 2, n_embd, n_embd, kernel_size=so_fuse_kernel_size, num_layers=2)
        self.bbox_so_embd = MaskedConv1D(self.n_bbox_so, n_embd, n_embd_ks, stride=1, padding=n_embd_ks//2)
        self.so_visual_bbox_fuse = ConvMLP(n_embd * 2, n_embd, n_embd, kernel_size=visual_bbox_ks, num_layers=2)
